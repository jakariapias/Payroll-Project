...
$sql2="INSERT INTO `payment` (`pay_no`, `emp_id`, `name` ,`accno`, `year`, `month`, `absence`, `loan_cut`, `pfunt_cut`,  `overtime`, `season_bonus`, `other_bonus`, `medi_allow`, `house_allow`, `total_pay`) VALUES (NULL, '$empid','$name','$acc', '$year', '$month', '$absence*200', '$loan_cut', '$pfund_cut', '$overtime*300', '$sbonus', '$obonus', '$medi_allow', '$house_allow', '$total');";
