...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          ...
          <div class="w3-display-middle w3-large" > <h1  style="color:sky" >Welcome to our Payroll system</h1></div>
      </div>
  ...
  <div class="w3-display-topmiddle" style="font-size: 30px; width:100%; margin-top:90px; margin-left:150px; "><p>Welcome to payroll system. This is our home page.</p></div>
  <div class="w3-display-left w3-container"></div>
  <div class="w3-display-right w3-container"></div>
  <!-- <div class="w3-display-middle w3-large w3-text-black">this website is in its early stage.</div> -->
...
<!-- W3.CSS Container -->
<!-- <div class="w3-dark-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px"><p class="w3-right">jakaria <a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" class="w3-hover-opacity">w3school</a></p></div> -->
